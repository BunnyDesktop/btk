...
#define BTK_CELL_RENDERER_PIXBUF(obj)			(B_TYPE_CHECK_INSTANCE_CAST ((obj), BTK_TYPE_CELL_RENDERER_PIXBUF, BtkCellRendererPixbuf))
#define BTK_CELL_RENDERER_PIXBUF_CLASS(klass)		(B_TYPE_CHECK_CLASS_CAST ((klass), BTK_TYPE_CELL_RENDERER_PIXBUF, BtkCellRendererPixbufClass))
#define BTK_IS_CELL_RENDERER_PIXBUF(obj)		(B_TYPE_CHECK_INSTANCE_TYPE ((obj), BTK_TYPE_CELL_RENDERER_PIXBUF))
#define BTK_IS_CELL_RENDERER_PIXBUF_CLASS(klass)	(B_TYPE_CHECK_CLASS_TYPE ((klass), BTK_TYPE_CELL_RENDERER_PIXBUF))
#define BTK_CELL_RENDERER_PIXBUF_GET_CLASS(obj)         (B_TYPE_INSTANCE_GET_CLASS ((obj), BTK_TYPE_CELL_RENDERER_PIXBUF, BtkCellRendererPixbufClass))

...
#define BTK_INVISIBLE(obj)		(B_TYPE_CHECK_INSTANCE_CAST ((obj), BTK_TYPE_INVISIBLE, BtkInvisible))
#define BTK_INVISIBLE_CLASS(klass)	(B_TYPE_CHECK_CLASS_CAST ((klass), BTK_TYPE_INVISIBLE, BtkInvisibleClass))
#define BTK_IS_INVISIBLE(obj)		(B_TYPE_CHECK_INSTANCE_TYPE ((obj), BTK_TYPE_INVISIBLE))
#define BTK_IS_INVISIBLE_CLASS(klass)	(B_TYPE_CHECK_CLASS_TYPE ((klass), BTK_TYPE_INVISIBLE))
#define BTK_INVISIBLE_GET_CLASS(obj)    (B_TYPE_INSTANCE_GET_CLASS ((obj), BTK_TYPE_INVISIBLE, BtkInvisibleClass))

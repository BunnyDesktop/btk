/* btkiconview.h
 * Copyright (C) 2002, 2004  Anders Carlsson <andersca@bunny.org>
 *
...
struct _BtkIconViewClass
{
  ...
  bboolean (* move_cursor)           (BtkIconView      *icon_view,
				      BtkMovementStep   step,
				      bint              count);
  bboolean (* activate_cursor_item)  (BtkIconView      *icon_view);
};
...
void           btk_icon_view_set_text_column   (BtkIconView    *icon_view,
	 	 			        bint            column);
bint           btk_icon_view_get_text_column   (BtkIconView    *icon_view);
void           btk_icon_view_set_markup_column (BtkIconView    *icon_view,
					        bint            column);
bint           btk_icon_view_get_markup_column (BtkIconView    *icon_view);
void           btk_icon_view_set_pixbuf_column (BtkIconView    *icon_view,
					        bint            column);
bint           btk_icon_view_get_pixbuf_column (BtkIconView    *icon_view);
...
void           btk_icon_view_set_columns       (BtkIconView    *icon_view,
		 			        bint            columns);
bint           btk_icon_view_get_columns       (BtkIconView    *icon_view);
void           btk_icon_view_set_item_width    (BtkIconView    *icon_view,
					        bint            item_width);
bint           btk_icon_view_get_item_width    (BtkIconView    *icon_view);
void           btk_icon_view_set_spacing       (BtkIconView    *icon_view, 
		 			        bint            spacing);
bint           btk_icon_view_get_spacing       (BtkIconView    *icon_view);
void           btk_icon_view_set_row_spacing   (BtkIconView    *icon_view, 
					        bint            row_spacing);
bint           btk_icon_view_get_row_spacing   (BtkIconView    *icon_view);
void           btk_icon_view_set_column_spacing (BtkIconView    *icon_view, 
					        bint            column_spacing);
bint           btk_icon_view_get_column_spacing (BtkIconView    *icon_view);
void           btk_icon_view_set_margin        (BtkIconView    *icon_view, 
					        bint            margin);
bint           btk_icon_view_get_margin        (BtkIconView    *icon_view);
void           btk_icon_view_set_item_padding  (BtkIconView    *icon_view, 
					        bint            item_padding);
bint           btk_icon_view_get_item_padding  (BtkIconView    *icon_view);


BtkTreePath *  btk_icon_view_get_path_at_pos   (BtkIconView     *icon_view,
						bint             x,
						bint             y);
bboolean       btk_icon_view_get_item_at_pos   (BtkIconView     *icon_view,
						bint              x,
						bint              y,
						BtkTreePath     **path,
						BtkCellRenderer **cell);
bboolean       btk_icon_view_get_visible_range (BtkIconView      *icon_view,
...
void             btk_icon_view_unselect_path      (BtkIconView            *icon_view,
						   BtkTreePath            *path);
bboolean         btk_icon_view_path_is_selected   (BtkIconView            *icon_view,
						   BtkTreePath            *path);
bint             btk_icon_view_get_item_row       (BtkIconView            *icon_view,
                                                   BtkTreePath            *path);
bint             btk_icon_view_get_item_column    (BtkIconView            *icon_view,
                                                   BtkTreePath            *path);
...
bboolean         btk_icon_view_get_cursor         (BtkIconView            *icon_view,
						   BtkTreePath           **path,
						   BtkCellRenderer       **cell);
...
bboolean               btk_icon_view_get_reorderable          (BtkIconView              *icon_view);
...
void                   btk_icon_view_get_drag_dest_item       (BtkIconView              *icon_view,
							       BtkTreePath             **path,
							       BtkIconViewDropPosition  *pos);
bboolean               btk_icon_view_get_dest_item_at_pos     (BtkIconView              *icon_view,
							       bint                      drag_x,
							       bint                      drag_y,
							       BtkTreePath             **path,
							       BtkIconViewDropPosition  *pos);
...
void    btk_icon_view_set_tooltip_cell                        (BtkIconView     *icon_view,
                                                               ...
                                                               BtkTreePath     *path,
                                                               BtkCellRenderer *cell);
bboolean btk_icon_view_get_tooltip_context                    (BtkIconView       *icon_view,
                                                               bint              *x,
                                                               bint              *y,
...
void     btk_icon_view_set_tooltip_column                     (BtkIconView       *icon_view,
                                                               bint               column);
bint     btk_icon_view_get_tooltip_column                     (BtkIconView       *icon_view);

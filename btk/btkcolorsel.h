...
#define BTK_COLOR_SELECTION(obj)			(B_TYPE_CHECK_INSTANCE_CAST ((obj), BTK_TYPE_COLOR_SELECTION, BtkColorSelection))
#define BTK_COLOR_SELECTION_CLASS(klass)		(B_TYPE_CHECK_CLASS_CAST ((klass), BTK_TYPE_COLOR_SELECTION, BtkColorSelectionClass))
#define BTK_IS_COLOR_SELECTION(obj)			(B_TYPE_CHECK_INSTANCE_TYPE ((obj), BTK_TYPE_COLOR_SELECTION))
#define BTK_IS_COLOR_SELECTION_CLASS(klass)		(B_TYPE_CHECK_CLASS_TYPE ((klass), BTK_TYPE_COLOR_SELECTION))
#define BTK_COLOR_SELECTION_GET_CLASS(obj)              (B_TYPE_INSTANCE_GET_CLASS ((obj), BTK_TYPE_COLOR_SELECTION, BtkColorSelectionClass))

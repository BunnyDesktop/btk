...
#define BTK_SEARCH_ENGINE_QUARTZ(obj)			(B_TYPE_CHECK_INSTANCE_CAST ((obj), BTK_TYPE_SEARCH_ENGINE_QUARTZ, BtkSearchEngineQuartz))
#define BTK_SEARCH_ENGINE_QUARTZ_CLASS(klass)		(B_TYPE_CHECK_CLASS_CAST ((klass), BTK_TYPE_SEARCH_ENGINE_QUARTZ, BtkSearchEngineQuartzClass))
#define BTK_IS_SEARCH_ENGINE_QUARTZ(obj)		(B_TYPE_CHECK_INSTANCE_TYPE ((obj), BTK_TYPE_SEARCH_ENGINE_QUARTZ))
#define BTK_IS_SEARCH_ENGINE_QUARTZ_CLASS(klass)	(B_TYPE_CHECK_CLASS_TYPE ((klass), BTK_TYPE_SEARCH_ENGINE_QUARTZ))
#define BTK_SEARCH_ENGINE_QUARTZ_GET_CLASS(obj)		(B_TYPE_INSTANCE_GET_CLASS ((obj), BTK_TYPE_SEARCH_ENGINE_QUARTZ, BtkSearchEngineQuartzClass))

...
and expat*.  See the build/win32/vs11/README.txt file in bunnylib for
...
BTK+ stack, VS11 project files are either available under
$(srcroot)/build/vs11 in the case of GLib (stable/unstable), BATK
(unstable) and BDK-Pixbuf (unstable), and should be in the next
unstable version of Bango.  There is no known official VS11 build
...
<root>\vs11\<PlatformName>\lib and BTK+ headers into
<root>\vs11\<PlatformName>\include\btk-2.0. This is then from where

...
BTK+ stack, VS9 project files are either available under
$(srcroot)/build/vs9 in the case of GLib (stable/unstable), BATK
(unstable) and BDK-Pixbuf (unstable), and should be in the next
unstable version of Bango.  There is no known official VS9 build
...
<root>\vs9\<PlatformName>\lib and BTK+ headers into
<root>\vs9\<PlatformName>\include\btk-2.0. This is then from where

...
and expat*.  See the build/win32/vs12/README.txt file in bunnylib for
...
BTK+ stack, VS12 project files are either available under
$(srcroot)/build/vs12 in the case of GLib (stable/unstable), BATK
(unstable) and BDK-Pixbuf (unstable), and should be in the next
unstable version of Bango.  There is no known official VS12 build
...
<root>\vs12\<PlatformName>\lib and BTK+ headers into
<root>\vs12\<PlatformName>\include\btk-2.0. This is then from where

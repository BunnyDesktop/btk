...
and expat*.  See the build/win32/vs14/README.txt file in bunnylib for
...
BTK+ stack, VS14 project files are either available under
$(srcroot)/build/vs14 in the case of GLib (stable/unstable), BATK
(unstable) and BDK-Pixbuf (unstable), and should be in the next
unstable version of Bango.  There is no known official VS14 build
...
<root>\vs14\<PlatformName>\lib and BTK+ headers into
<root>\vs14\<PlatformName>\include\btk-2.0. This is then from where

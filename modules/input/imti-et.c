...
static void ti_et_class_init (BtkIMContextSimpleClass *class);
static void ti_et_init (BtkIMContextSimple *im_context);
...
static buint16 ti_et_compose_seqs[] = {
...
static void
ti_et_class_init (BtkIMContextSimpleClass *class)
{
}

static void
ti_et_init (BtkIMContextSimple *im_context)
{
...
static const BtkIMContextInfo ti_et_info = { 
  "ti_et",		   /* ID */
...
#else
#define MODULE_ENTRY(type, function) type _btk_immodule_ti_et_ ## function
#endif

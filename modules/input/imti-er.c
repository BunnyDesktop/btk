...
static void ti_er_class_init (BtkIMContextSimpleClass *class);
static void ti_er_init (BtkIMContextSimple *im_context);
...
static void
ti_er_class_init (BtkIMContextSimpleClass *class)
{
}

static void
ti_er_init (BtkIMContextSimple *im_context)
{
...
static const BtkIMContextInfo ti_er_info = { 
  "ti_er",		   /* ID */
...
#else
#define MODULE_ENTRY(type, function) type _btk_immodule_ti_er_ ## function
#endif
